...
const DEMO_DEFS: Record<string, CardDef> = {
  ...
  "SMD-1-003": def({
    ...
    name: "Boiled",
    bp: 3500,
    effectIds: ["double_block", "block_guard_2000"],
  ...
  "SMD-1-007": def({
    ...
    bp: 4000,
    apCost: 2,
    requiredEnergy: [{ color: "yellow", amount: 4 }],
    effectIds: ["place_opponent_front_into_life_on_play"],
    hasTrigger: true,
    triggerType: "draw",
  ...
  "SMD-1-008": def({
    ...
    bp: 4000,
    apCost: 1,
    requiredEnergy: [{ color: "yellow", amount: 5 }],
    keywords: ["raid"],
    hasTrigger: true,
    triggerType: "raid",
